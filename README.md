...
* Исправление кода автотестов при возможных изменениях структуры сайта: риск недоступности css-селекторы 
* Нагрузка на сайт при запуске тестов, что может привести к увеличению времени загрузки страниц
